...
func TestCallTreeAggregation(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			callTrees: []*AggregateCallTree{
				{"lib1", "func1", "func1-demangled", 1, "path1", "package1", fs(), fs(), []*AggregateCallTree{
					{"lib2", "func2", "func2-demangled", 2, "path2", "package2", fs(), fs(), nil},
				}},
				{"lib1", "func1", "func1-demangled", 3, "path3", "package3", fs(), fs(), []*AggregateCallTree{
					{"lib2", "func2", "func2-demangled", 4, "path4", "package4", fs(), fs(), nil},
				}},
			},
			want: map[string]*AggregateCallTree{
				"d39e48044f2412b016d894e74e8695d7": {"lib1", "func1", "func1-demangled", 3, "path3", "package3", fs(), fs(), []*AggregateCallTree{
					{"lib2", "func2", "func2-demangled", 4, "path4", "package4", fs(), fs(), nil},
				}},
			},
		},
